...
- [x] PRD
- [x] Database design (in architecture)
- [x] API specification
...
- [x] Create frontend directory skeleton
- [x] Create backend directory skeleton
- [x] Create n8n directory skeleton
...
- [ ] Install/configure PostgreSQL (or use Docker)
- [ ] Configure n8n
...
- [x] Create React application skeleton
...
1. [x] Reorganize documentation into docs/
2. [x] Create project structure (backend, frontend, n8n, database, tests)
3. [x] Create `.gitignore`, `.env.example`, `docker-compose.yml`
4. [ ] Set up backend Python environment + dependencies
5. [ ] Set up PostgreSQL (via Docker)
